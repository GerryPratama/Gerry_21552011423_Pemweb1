...
<html>
  <head>
    ...
    <title>Service - UAS Pemrograman Web 1</title>
    <link
      ...
      <div class="container">
        ...
        <div class="box">
          <div class="col-4 x-box">
            <div class="icon"><i class="material-icons">room_preferences</i></div>
            <h5>Pengelolaan Gedung</h5>
          </div>
          <div class="col-4 x-box">
            <div class="icon"><i class="material-icons">manage_accounts</i></div>
            <h5>Pelatihan SDM</h5>
          </div>
          <div class="col-4 x-box">
            <div class="icon"><i class="material-icons">public</i></div>
            <h5>Jaringan Internet</h5>
          </div>
          <div class="col-4 x-box">
            <div class="icon"><i class="material-icons">lan</i></div>
            <h5>E-Procurement</h5>
          </div>
        </div>
      </div>
