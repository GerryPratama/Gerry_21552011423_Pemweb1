...
// cek apakah tombol tambah job ditekan
if (isset($_POST['tambah_job'])) {
  // ambil data
  $job = $_POST['nama_job'];
  $gender = $_POST['gender'];
  $umur = $_POST['umur'];
  ...
  if ($job === "" && $gender === "" && $umur === "" && $pendidikan === "" && $tanggungJawab === "" && $keahlian === "") {
    ...
    $ob->createJob($job, $gender, $umur, $pendidikan, $tempat, $tanggungJawab, $keahlian);
    echo "<script>
...
<html lang="en">
  <head>
    ...
    <title>Tambah Job - UAS Pemrograman Web 1</title>
    <link
            ...
            <div class="row">
              ...
              <form action="" method="POST">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="nama_job" name="nama_job" aria-describedby="job" placeholder="masukan nama job...">
                </div>
                <div class="mb-3">
                  <label for="gender" class="form-label">Gender</label>
                  <input type="text" class="form-control" id="gender" name="gender" placeholder="masukan gender...">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="tanggung_jawab" name="tanggung_jawab" placeholder="masukan tanggung jawab...">
                </div>
                <div class="mb-3">
                  <label for="skill" class="form-label">Keahlian</label>
                  <input type="text" class="form-control" id="skill" name="skill" placeholder="masukan keahlian...">
                </div>
                <button type="submit" name="tambah_job" class="btn btn-primary">Submit</button>
              </form>
              </div>
