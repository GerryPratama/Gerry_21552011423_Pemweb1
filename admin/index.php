...
// ambil data job 
$data = $ob->read("SELECT * FROM job ORDER BY id_job DESC");
$data = $data->fetchAll();
...
<html lang="en">
  <head>
    ...
    <title>Dashboard - UAS Pemrograman Web 1</title>
    <link
                ...
                <table class="table table-success table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $dt['pendidikan'];?></td>
                      <td><?= $dt['tempat'];?></td>
                      <td><?= $dt['tanggung_jawab'];?></td>
                      <td><?= $dt['keahlian'];?></td>
                      <td><a href="edit_job.php?id=<?= $dt['id_job'];?>">Edit</a> | <a href="hapus_job.php?id=<?= $dt['id_job'];?>" onclick="return confirm('yakin?')">Hapus</a></td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
